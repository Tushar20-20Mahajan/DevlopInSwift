...
// This line will throw a NumberFormatException at runtime
...
print("The value of userAge is nil because the string \"34e\" cannot be successfully converted to an integer. The Int() initializer returns an optional Int? in Swift, and if the conversion is not possible, it assigns nil to the variable. In this case, \"34e\" contains non-numeric characters (\"e\" in scientific notation), which makes it an invalid representation of an integer. As a result, the conversion to Int returns nil. The use of the optional type (Int?) allows Swift to handle cases where the conversion might fail.")
/*:
...
print("Unwrapped userAge: \(userAge!)")
