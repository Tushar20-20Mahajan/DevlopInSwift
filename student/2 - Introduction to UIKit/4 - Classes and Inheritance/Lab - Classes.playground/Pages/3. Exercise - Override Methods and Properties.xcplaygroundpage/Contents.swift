...
defender.fire()
print("The remaning fire is \(defender.remainingFirePower)")
...
defender.wasHit()
print("The shieldStrength of \(defender.name) is \(defender.shieldStrength) and its health is \(defender.health)")
...
print("The position of \(defender.name) is \(defender.position)")
defender.fire()
print("The remaining fire is \(defender.remainingFirePower)")
