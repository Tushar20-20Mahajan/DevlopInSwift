...
var statesWithCaptials = [String:String]()

var home = ["Punjab","Chandigarh"]
var foundHome = false

statesWithCaptials = ["Harayana": "Chandigarh", "Himachal Pardesh":"Shimla" ,"Punjab":"Chandigarh" , "Rajisthan": "Jaipur"]
for (keyPart , valuePart) in statesWithCaptials{
    if(keyPart==home[0] && valuePart==home[1]){
...
if(foundHome==false){
    print("I was not able to find my home!")
}
/*:
