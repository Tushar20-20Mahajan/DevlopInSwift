...
walkingChallenges += ["Walk 3 miles a Day" , "The Goal of the Day is to walk atleast 10000 steps"]
runningChallenges += [ "Run 2 miles a Day" , "The Goal of the Day is to run atleast 30 min"]
...
var challenges = [walkingChallenges]
...
newChallenges.append("The Goal of the Day is to walk atleast 10000 steps")
...
if(newChallenges.isEmpty){
    ...
    print("The challenge you have chosen is \"The Goal of the Day is to walk atleast 10000 steps.\"")
}else{
