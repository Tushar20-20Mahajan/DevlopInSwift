...
var favoriteBook = Book(title: "The Merchant of Venice"
                        ,author : "W.Shakespear"
                        ,pages :1000
                        ,price : 999.99)
print(favoriteBook)
...
var laptop2 = Laptop(yearPurchased: 2021)
...
print("Height in Centimeters is \(heightInInches.heightInCentimeters)")

let heightInCentimeters = Height(heightInCentimeters: 165.1)
print("Height in Inches is \(heightInCentimeters.heightInInches)")
...
print("Height in Centimeters is \(someHeight.heightInCentimeters)")
...
print("Height in Inches is \(myHeight.heightInInches)")
