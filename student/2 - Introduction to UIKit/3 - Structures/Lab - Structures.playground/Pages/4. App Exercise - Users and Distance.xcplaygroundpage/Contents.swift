...
var myName = User(name: "Tushar Mahajan", age: 21, height: 181.34, weight: 82.5, activityLevel: 9)
print(myName)
...
struct Distance{
    ...
    init(distanceInMeter: Double) {
        self.distanceInMeters = distanceInMeter
        self.distanceInFeet = distanceInMeter * 3.28084
    }
...
var mile = Distance(distanceInMeter: 1600)
print("Distance in feets are \(mile.distanceInFeet)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var inMeter = Distance(distanceInFeet: 5249.344)
var inFeet = Distance(distanceInMeter: 1600)
print("Distance in feets are \(inFeet.distanceInFeet)")
print("Distance in meter are \(inMeter.distanceInMeters)")
/*:
