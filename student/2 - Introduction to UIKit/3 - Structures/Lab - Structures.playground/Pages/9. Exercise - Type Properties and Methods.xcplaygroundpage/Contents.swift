...
struct User {
    ...
    static var currentUser: User = User(userName: "YourUserName", email: "your.email@example.com", age: 25)
    
    static var oldCurrentUser: User?
...
let newUser = User(userName: "AnotherUser", email: "another.user@example.com", age: 30)
