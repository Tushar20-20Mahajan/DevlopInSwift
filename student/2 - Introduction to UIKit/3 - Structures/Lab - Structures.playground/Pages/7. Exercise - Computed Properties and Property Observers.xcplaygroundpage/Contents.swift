...
struct Rectangle {
    ...
    func areaOfRectangele(){
        print("The area of the Rectange of width \(width) and height\(height) is \(width*height)")
    }
...
var personHeight = Height(heightInInches: 65.0)


personHeight.heightInCentimeters = 170.0
